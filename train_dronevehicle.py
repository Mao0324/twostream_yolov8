...
# 1) 模型结构
model = YOLO('/home/biiteam/Storage-4T/biiteam/MCONG/TwoStream_Yolov8_2/yaml/yolov8_twostream_obb_assafusion_p3local_align_lightp5.yaml')
...
results = model.train(
    ...
    imgsz=640,
    device='5,6',
    project='dronevehicle_runs_assafusion_p3local_align_lightp5',
    task='obb'
)
