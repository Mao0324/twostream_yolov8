...
# 1) 模型结构
model = YOLO('/home/biiteam/Storage-4T/biiteam/MCONG/TwoStream_Yolov8_2/yaml/yolov8_twostream_obb_assafusion.yaml')
...
results = model.train(
    ...
    imgsz=640,
    device='5,6',
    project='dronevehicle_runs_assafusion_init_scale1e-2',
    task='obb'
)
