...
# 1) 模型结构
model = YOLO('/home/biiteam/Storage-4T/biiteam/MCONG/TwoStream_Yolov8_2/yaml/yolov8_twostream_obb_assafusion_cls_enhance_p3p4_postc2f.yaml')
...
results = model.train(
    ...
    imgsz=640,
    device='1,7',
    project='dronevehicle_runs_assafusion_c2f_fusion_conv_p3p4clsenhance',
    task='obb'
)
