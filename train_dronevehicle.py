...
# 1) 模型结构
model = YOLO('/home/biiteam/Storage-4T/biiteam/MCONG/TwoStream_Yolov8_2/yaml/yolov8_twostream_obb_assafusion_denseonly_p3_p4p5assa_postc2f.yaml')
...
results = model.train(
    ...
    imgsz=640,
    device='4,5',
    project='dronevehicle_runs_assafusion_c2f_fusion_conv_p3denseonly_p4p5assa',
    task='obb'
)
